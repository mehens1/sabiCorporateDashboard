        ...
        <div class="row align-items-center justify-content-lg-between">
          <div class="col-lg-6 mb-lg-0 mb-4">
            <div class="copyright text-center text-sm text-muted text-lg-start">
              ...
              Developed by
              <a href="https://www.mehenscreatives.com" class="font-weight-bold" target="_blank">MEHENS CREATIVES TECHNOLOGY</a>
            </div>
          </div>
          <div class="col-lg-6">
            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
              <li class="nav-item">
                <a href="http://sabicorporate.com" class="nav-link text-muted" target="_blank">Home</a>
              </li>
              <li class="nav-item">
                <a href="http://sabicorporate.com/#about" class="nav-link text-muted" target="_blank">About Us</a>
              </li>
              <li class="nav-item">
                <a href="http://sabicorporate.com/blog" class="nav-link text-muted" target="_blank">Blog</a>
              </li>
              <li class="nav-item">
                <a href="http://sabicorporate.com/#contact" class="nav-link pe-0 text-muted" target="_blank">Contact</a>
              </li>
            </ul>
          </div>
        </div>
