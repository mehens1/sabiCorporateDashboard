              ...
              <ul class="navbar-nav mx-auto ms-xl-auto me-xl-7">
                <li class="nav-item">
                  <a class="nav-link me-2" href="https://sabicorporate.com/">
                    <i class="fa fa-user opacity-6 text-success me-1"></i>
                    Home
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link me-2" href="https://sabicorporate.com/#about">
                    <i class="fas fa-user-circle opacity-6 text-success me-1"></i>
                    About
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link me-2" href="https://sabicorporate.com/#service">
                    <i class="fas fa-key opacity-6 text-success me-1"></i>
                    Service
                  </a>
                </li>
                <li class="nav-item">
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form">
                    ...
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Email or Phone Number" aria-label="Email" aria-describedby="email-addon">
                    </div>
                    ...
                    <div class="text-center">
                      <button type="button" class="btn bg-gradient-success w-100 mt-4 mb-0">Sign in</button>
                    </div>
                  </form>
                </div>
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                    <p class="mb-4 text-sm mx-auto">
                      Forgot Password?
                      <a href="javascript:;" class="text-success text-gradient font-weight-bold">Recover</a>
                    </p>
                  </div>
              </div>
            </div>
